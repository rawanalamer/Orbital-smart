...
//  orbitalSample
//
//  Created by Rawan Alamer on 6/3/17.
...
class StoreTableViewController: UITableViewController {
    ...
    @IBOutlet var listOfStores: UITableView!
    ...
    func get(){
        let url = NSURL(string: "listAllStores.php")
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
     ...
     func tableView(listOfStores: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.unit.text = mainData["unit"] as? String
        cell.opening.text = mainData["opening"] as? String
        cell.website.text = mainData["website"] as? String
        cell.number.text = mainData["number"] as? String
        cell.description.text = mainData["description"] as? String
    }
